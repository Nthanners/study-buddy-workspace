...
app.get('/api/notes', requireAuth, async (req, res) => res.json(await read('notes')))
...
app.get('/api/tasks', requireAuth, async (req, res) => res.json(await read('tasks')))
